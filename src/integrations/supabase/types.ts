  ...
  public: {
    Tables: {
      ...
      lead_campaign_spend: {
        ...
        Relationships: [
          {
            foreignKeyName: "lead_campaign_spend_branch_id_fkey"
            columns: ["branch_id"]
            isOneToOne: false
            referencedRelation: "branches"
            referencedColumns: ["id"]
      ...
      lead_followups: {
        ...
        Relationships: [
          {
            foreignKeyName: "lead_followups_branch_id_fkey"
            columns: ["branch_id"]
            isOneToOne: false
            referencedRelation: "branches"
            referencedColumns: ["id"]
      ...
      lead_lost_reasons: {
        ...
        Relationships: [
          {
            foreignKeyName: "lead_lost_reasons_branch_id_fkey"
            columns: ["branch_id"]
            isOneToOne: false
            referencedRelation: "branches"
            referencedColumns: ["id"]
      ...
      lead_pipeline_stages: {
        ...
        Relationships: [
          {
            foreignKeyName: "lead_pipeline_stages_branch_id_fkey"
            columns: ["branch_id"]
            isOneToOne: false
            referencedRelation: "branches"
            referencedColumns: ["id"]
      ...
      meta_ads_sync_runs: {
        ...
        Relationships: [
          {
            foreignKeyName: "meta_ads_sync_runs_connection_id_fkey"
            columns: ["connection_id"]
            isOneToOne: false
            referencedRelation: "meta_ads_connections"
            referencedColumns: ["id"]
          },
        ]
      }
      notification_settings: {
        Row: {
          ...
          smsmisr_environment: number
          smsmisr_language: number
      ...
      physio_cases: {
        ...
        Relationships: [
          {
            foreignKeyName: "physio_cases_appointment_id_fkey"
            columns: ["appointment_id"]
            isOneToOne: false
            referencedRelation: "appointments"
            referencedColumns: ["id"]
      ...
      platform_change_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "platform_change_log_actor_id_fkey"
            columns: ["actor_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "platform_change_log_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      self_checkin_tokens: {
        ...
        Relationships: [
          {
            foreignKeyName: "self_checkin_tokens_appointment_id_fkey"
            columns: ["appointment_id"]
            isOneToOne: true
            referencedRelation: "appointments"
            referencedColumns: ["id"]
      ...
      subscription_change_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "subscription_change_log_new_plan_id_fkey"
            columns: ["new_plan_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "subscription_change_log_previous_plan_id_fkey"
          ...
          {
            foreignKeyName: "subscription_change_log_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      tenant_domains: {
        ...
        Relationships: [
          {
            foreignKeyName: "tenant_domains_default_branch_id_fkey"
            columns: ["default_branch_id"]
            isOneToOne: false
            referencedRelation: "branches"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      v_authz_shadow_matrix_invoices: {
        Row: {
          expected_decision: boolean | null
          last_seen: string | null
          observations: number | null
      ...
      v_authz_shadow_matrix_medical_records: {
        Row: {
          expected_decision: boolean | null
          last_seen: string | null
          observations: number | null
    ...
    Functions: {
      ...
      create_self_checkin_link: {
        Args: { p_appointment_id: string; p_ttl_minutes?: number }
        Returns: {
          appointment_id: string
          expires_at: string
          token: string
      ...
      invoke_reminder_function: {
        Args: { _body?: Json; _fn: string }
        Returns: number
      }
      is_tenant_owner: { Args: { _tenant_id: string }; Returns: boolean }
      lead_staff_access: { Args: { _branch_id: string }; Returns: boolean }
      list_doctors: {
        Args: never
        Returns: {
          full_name: string
      ...
      meta_ads_admin_access: { Args: { _branch_id: string }; Returns: boolean }
      platform_create_tenant_onboarding: {
        Args: { payload: Json }
        Returns: Json
      }
      ...
      prune_client_errors: { Args: { _keep_days?: number }; Returns: number }
      prune_phi_access_log: { Args: { p_keep_days?: number }; Returns: number }
      public_booking_options: { Args: never; Returns: Json }
      ...
      tenant_subscription_snapshot: {
        Args: { _tenant_id: string }
        Returns: Json
      }
      upsert_notification_settings: {
        Args: { p_branch_id: string; p_settings: Json }
        Returns: undefined
      }
    ...
    Enums: {
      ...
      sms_provider: "twilio" | "messagebird" | "custom" | "smsmisr"
