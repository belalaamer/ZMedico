...
export const dict = {
  en: {
    ...
    overwriteScheduleConfirm: "This will overwrite existing schedules for the selected staff. Continue?",
    sun: "Sun",
    mon: "Mon",
    tue: "Tue",
    wed: "Wed",
  ...
  ar: {
    ...
    overwriteScheduleConfirm: "سيتم استبدال الجداول الحالية للموظفين المحددين. متابعة؟",
    sun: "أحد",
    mon: "إثنين",
    tue: "ثلاثاء",
    wed: "أربعاء",
