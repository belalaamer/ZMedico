...
BEGIN
  ...
  BEGIN
    ...
    PERFORM set_config('request.jwt.claims',
      json_build_object('sub',(SELECT user_id FROM public.user_roles WHERE role::text='admin' LIMIT 1)::text,
  ...
  BEGIN
    ...
    PERFORM public.void_invoice_financials(v_invoice, (SELECT user_id FROM public.user_roles WHERE role::text='admin' LIMIT 1));
