-- Compatibility patch for PHI collection-view audit calls already deployed
-- by the current frontend. Documents and Dental tabs historically pass
-- patientId as entityId; retain authorization while accepting that shape.
